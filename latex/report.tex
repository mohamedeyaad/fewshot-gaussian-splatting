...
\begin{table}[htbp]
  ...
  \begin{tabular}{llcccc}
    ...
    & \textbf{100\%} & \textbf{200\%} \\
    \midrule
    \multirow{3}{*}{Inpainting} & 5 & -0.039 & -0.142\,* & -0.166\,* & +0.029 \\
     & 10 & +0.014 & -0.142\,* & -0.213\,* & -0.141 \\
     & 20 & -0.032 & -0.073\,* & -0.161\,* & -0.102\,* \\
    \addlinespace
    \multirow{3}{*}{Outpainting} & 5 & +0.140\,* & +0.140\,* & +0.182\,* & +0.285\,* \\
     & 10 & +0.172\,* & +0.013 & -0.423\,* & -0.003 \\
     & 20 & -0.283\,* & -0.542\,* & -0.983\,* & -0.618\,* \\
    \addlinespace
    \multirow{3}{*}{Pose-guided} & 5 & -0.309\,* & -0.375\,* & -0.719\,* & -1.013\,* \\
     & 10 & -0.451\,* & -0.855\,* & -1.404\,* & -1.451\,* \\
     & 20 & -1.017\,* & -1.528\,* & -1.729\,* & -1.884\,* \\
    \addlinespace
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{table}[htbp]
  ...
  \begin{tabular}{lcccccc}
    ...
    \midrule
    No augmentation & 232 & 1.3 & 371 & 1.3 & 305 & 2.0 \\
    Inpainting & 250 & 1.4 & 280 & 1.4 & 302 & 2.0 \\
    Outpainting & 359 & 2.1 & 364 & 2.0 & 411 & 2.5 \\
    Pose-guided & 316 & 2.1 & 326 & 1.9 & 335 & 2.3 \\
    \bottomrule
  \end{tabular}
\end{table}
