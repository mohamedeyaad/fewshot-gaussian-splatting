...
<p>Model complexity tracks the damage. Against a baseline of {{FLOOR_GAUSS}} Gaussians,
inpainting barely moves the count — it adds no new scene area — while outpainting drives it
up by roughly a third and pose-guided further still. Multi-view inconsistency forces the
optimiser to spawn semi-transparent Gaussians that satisfy each contradictory view
